...
namespace Veil.Compiler
{
    ...
    internal class WriteModelExpressionTests : CompilerTestBase
    {
        ...
        {
            var template = CreateTemplate(WriteModelExpressionNode.Create(model.GetType(), "Data"));
        ...
        {
            var template = CreateTemplate(WriteModelExpressionNode.Create(model.GetType(), "DataField"));
            var result = ExecuteTemplate(template, model);
